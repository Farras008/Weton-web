...
<?php $section('Watak Hari'); ?><tr><td><?php $reading($r['watakHari'], 'Keterangan watak hari berdasarkan Primbon Jawa.'); ?></td></tr>
<?php $section('Watak Pasaran'); ?><tr><td><?php $reading($r['watakPasaran'], 'Keterangan watak pekan dan pasaran berdasarkan Primbon Jawa.'); ?></td></tr>
<?php $section('Watak Kelahiran'); ?><tr><td><?php $reading($r['watakKelahiran'], 'Keterangan watak bayi menurut hari dan pekan kelahiran berdasarkan Primbon Jawa.'); ?></td></tr>
<?php $section('Watak Bayi'); ?><tr><td><?php $subheading('Menurut jumlah neptu ' . $n['totalNeptu']); $reading($r['watakBayi'], 'Keterangan watak bayi berdasarkan Primbon Jawa.'); $subheading('Menurut tanggal lahir'); $reading($r['watakBayiTanggal'], 'Keterangan watak bayi menurut tanggal kelahiran berdasarkan Primbon Jawa.'); ?></td></tr>
